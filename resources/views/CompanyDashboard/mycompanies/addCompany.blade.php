        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('storecompany') }}" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="exampleInputName" class="form-label">Nationality</label>
                    ...
                    <div class="mb-3">
                        <label for="exampleInputName" class="form-label">numbers</label>
                        <input type="number" class="form-control" name="numbers" value="{{ old('numbers') }}"
                            id="exampleInputName" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <input id="imageInput" name="path" type="file" class="form-control"
